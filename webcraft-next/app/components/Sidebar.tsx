    ...
    <>
      ...
      {isPopoutOpen && (
        ...
        >
          <div
            className="ml-auto"
            onClick={(e) => e.stopPropagation()} // 🛑 mencegah close saat klik isi popout
          >
            <SidebarPopout onClose={() => setIsPopoutOpen(false)} />
          </div>
        </div>
      )}

      {/* 🧭 Sidebar */}
      <aside className="fixed left-0 top-0 h-screen w-72 bg-zinc-950 text-zinc-100 flex flex-col justify-between p-6 shadow-lg z-50">
        <div>
          {/* 🔹 Header */}
          ...
          <nav className="space-y-2">
            <a
              href="#"
              className="flex items-center gap-3 bg-zinc-800 rounded-xl px-3 py-2 hover:bg-zinc-700 transition"
            >
            ...
            <a
              href="#"
              className="flex items-center gap-3 px-3 py-2 hover:bg-zinc-800 rounded-xl transition"
            >
              <TrendingUp className="text-red-400" size={20} />
              <span>Trending</span>
              <kbd className="ml-auto bg-zinc-700 px-1.5 py-0.5 text-xs rounded">
                ctrl + s
              </kbd>
            </a>
            ...
            <button
              ...
              className="w-full text-left flex items-center gap-3 px-3 py-2 hover:bg-zinc-800 rounded-xl transition"
            >
